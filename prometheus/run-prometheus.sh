...
docker run -d --restart=always --name=prometheus -p 9090:9090 -v prometheus-data:/prometheus prom/prometheus --config.file=/prometheus/prometheus.yml || docker restart prometheus
